...
const PremiumCard=()=>{
    ...
    height:160,
            backgroundImage:'url("/dashboardimg/pop_project.png")'}}>
         <Box sx={{display:'flex',alignItems:'center',justifyContent:'space-between'}}>
               <Box sx={{ borderColor: '#9CA3AF', 
               backgroundColor:'#222222',
               borderRadius: '10px', p: 1, border: '2px solid #9CA3AF' }}>
  ...
  />
    ...
    borderStyle: 'solid', 
            ...
            <Box sx={{mt:2.8,display:'flex',alignItems:'center'}}>
                <Button variant='contained' endIcon={<EastIcon style={{ color: "#5553FF",
                fontSize:'1.7rem',
              fontWeight:'bold' }} />}sx={{
...
export default PopularProjectssec;